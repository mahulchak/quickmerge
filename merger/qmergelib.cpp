...
string tempname;
	for(unsigned int i =0; i<merge.r_name.size();i++)
	{
		...
		{ 	
//if(tempname=="000000F Backbone_25/0_5827827"){cout<<merge.ref_st[tempname][0]<<"\t"<<merge.q_st[tempname][0]<<"\t"<<merge.ref_len[tempname]<<"\t"<<ref_last<<"\t"<<merge.q_len[tempname]<<"\t"<<q_last<<endl;}	
